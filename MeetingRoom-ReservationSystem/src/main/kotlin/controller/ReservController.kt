...
class ReservController(private val reservaService: ReservService) {
    ...
    fun criarReserva(@RequestBody reserva: ReservRoom): Mono<ReservRoom> {
        /* Chama a classe ReservRoom da pasta Service para criar uma reserva e trata possíveis erros caso haja*/
    ...
    @GetMapping
    fun listarReservas(): Flux<ReservRoom> {
