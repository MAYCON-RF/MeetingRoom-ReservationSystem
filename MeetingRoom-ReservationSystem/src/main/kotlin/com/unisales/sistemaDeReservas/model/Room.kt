...
@Document(collection = "salas") /* a anotação @Entity para indicar que essa classe representa uma entidade do JPA.*/
data class Room(
    @Id
    ...
    val recursos: List<String>,            /* Lista de recursos (ex: projetor, quadro)*/
